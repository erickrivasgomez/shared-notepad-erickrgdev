  ...
  return (
    <form onSubmit={handleRegister} className="flex flex-col space-y-4">
      <div className="space-y-2">
        <label className="text-sm font-medium leading-none" htmlFor="display_name">
          Nombre de Usuario
        </label>
        <input
          id="display_name"
      ...
      <p className="text-center text-sm text-neutral-500 dark:text-neutral-400 mt-4">
        ¿Ya tienes cuenta? <Link href="/login" className="text-indigo-600 dark:text-indigo-400 hover:underline">Inicia Sesión</Link>
      </p>
    </form>
  );
}
